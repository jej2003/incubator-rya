...
import mvm.rya.indexing.freetext.SimpleTokenizer;
...
public class AccumuloFreeTextIndexerTest {
    ...
    public void before() throws Exception {
        ...
        conf.set(FreeTextConfig.FREE_TEXT_DOC_TABLENAME, tableName);
        conf.set(FreeTextConfig.FREE_TEXT_TERM_TABLENAME, termTableName);
