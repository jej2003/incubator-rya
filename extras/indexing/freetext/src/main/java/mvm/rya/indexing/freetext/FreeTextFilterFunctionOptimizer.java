...
public class FreeTextFilterFunctionOptimizer implements QueryOptimizer, Configurable {
    ...
    public FreeTextFilterFunctionOptimizer() {
    }


    public FreeTextFilterFunctionOptimizer(AccumuloRdfConfiguration conf) throws AccumuloException, AccumuloSecurityException,
