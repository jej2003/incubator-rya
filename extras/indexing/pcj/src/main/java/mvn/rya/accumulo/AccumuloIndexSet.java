...
import mvm.rya.indexing.external.tupleSet.ParsedQueryUtil;
import mvm.rya.rdftriplestore.evaluation.ExternalBatchingIterator;

import mvn.rya.accumulo.iterators.BindingSetHashJoinIterator;
import mvn.rya.accumulo.iterators.BindingSetHashJoinIterator.HashJoinType;
import mvn.rya.accumulo.iterators.IteratorCombiner;
import mvn.rya.accumulo.iterators.PCJKeyToCrossProductBindingSetIterator;
import mvn.rya.accumulo.iterators.PCJKeyToJoinBindingSetIterator;
import mvn.rya.indexing.pcj.matching.PCJOptimizerUtilities;
