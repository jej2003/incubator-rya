package mvm.rya.indexing.geospatial.accumulo;
...
import mvm.rya.indexing.geospatial.GeoMesaGeoIndexer;
...
public class GeoIndexerTest {
    ...
    public void before() throws Exception {
        ...
        conf.set(GeoConfig.GEO_TABLENAME, tableName);
    ...
    public void testRestrictPredicatesSearch() throws Exception {
        conf.setStrings(GeoConfig.GEO_PREDICATES_LIST, "pred:1,pred:2");
