...
public class GeoConstants {
	...
	static {
		...
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_EQUALS, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_DISJOINT, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_INTERSECTS, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_TOUCHES, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_WITHIN, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_CONTAINS, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_OVERLAPS, FUNCTION_TYPE.GEO);
		IndexingFunctionRegistry.register(GeoConstants.GEO_SF_CROSSES, FUNCTION_TYPE.GEO);
