...
public class GeoFilterFunctionOptimizer implements QueryOptimizer, Configurable {
    ...
    public GeoFilterFunctionOptimizer() {
    }


    public GeoFilterFunctionOptimizer(AccumuloRdfConfiguration conf) throws AccumuloException, AccumuloSecurityException,
    ...
    private void init() {
        if (!init) {
            if(conf.getBoolean(GeoConfig.USE_MONGO, false)) {
