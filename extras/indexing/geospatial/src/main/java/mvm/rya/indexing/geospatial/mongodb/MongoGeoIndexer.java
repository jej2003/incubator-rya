package mvm.rya.indexing.geospatial.mongodb;
...
import mvm.rya.indexing.geospatial.GeoIndexer;
import mvm.rya.indexing.geospatial.mongodb.GeoMongoDBStorageStrategy.GeoQueryType;
...
public class MongoGeoIndexer extends AbstractMongoIndexer implements GeoIndexer {
	...
	private void init() throws NumberFormatException, IOException{
        ...
        predicates = GeoConfig.getGeoPredicates(conf);
