...
public class GeoMesaGeoIndexer extends AbstractAccumuloIndexer implements GeoIndexer  {
    ...
    private void initInternal() throws IOException {
        validPredicates = GeoConfig.getGeoPredicates(conf);
    ...
    private static DataStore createDataStore(Configuration conf) throws IOException {
        ...
        String tableName = GeoConfig.getGeoTablename(conf);
        int numParitions = GeoConfig.getGeoNumPartitions(conf);
    ...
    public String getTableName() {
       return GeoConfig.getGeoTablename(conf);
    }
