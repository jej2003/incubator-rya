...
public final class AccumuloTemporalIndexerTest {
    ...
    public void setUp() throws Exception {
        ...
        conf.set(TemporalConfig.TEMPORAL_TABLENAME, uniquePerTestTemporalIndexTableName);
...
//        Assert.assertTrue("Invalid date parse error should be thrown for this bad date=" + invalidDateString, catchErrorThrownCorrectly);
    ...
    /**
     * Test method for
     * {@link AccumuloTemporalIndexer#queryIntervalEquals(TemporalInterval, StatementContraints)}
     * .
     * @throws IOException
