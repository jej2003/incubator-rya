...
public class TemporalFilterFunctionOptimizer implements QueryOptimizer, Configurable {
    ...
    public TemporalFilterFunctionOptimizer() {
    }


    public TemporalFilterFunctionOptimizer(AccumuloRdfConfiguration conf) throws AccumuloException, AccumuloSecurityException,
    ...
    private void init() {
        if (!init) {
            if (conf.getBoolean(TemporalConfig.USE_MONGO, false)) {
