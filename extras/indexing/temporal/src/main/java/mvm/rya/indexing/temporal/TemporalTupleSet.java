...
import mvm.rya.indexing.temporal.accumulo.TemporalInstantRfc3339;
...
public class TemporalTupleSet extends ExternalTupleSet {
     ...
     * <p>
     * Should be thread-safe (concurrent invocation this
    ...
    private class TemporalSearchFunctionFactory  {
        ...
        /**
         * Get a {@link SearchFunction} for a give URI.
         * 
